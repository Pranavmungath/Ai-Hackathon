...
class EventExtraction(BaseModel):
    ...
    description: str = Field(description="Raw description of the event with no loss of information")
...
class EventDetails(BaseModel):
    ...
    participants: list[str] = Field(description="List of names of participants required to attend the event")
